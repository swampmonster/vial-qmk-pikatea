...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_all(
        ...
        KC_LSFT, KC_BSLS, KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,      KC_LSFT,  KC_UP,          KC_UP,   KC_END,
        KC_LCTL, KC_LGUI,      KC_LALT,                            KC_SPC,                             KC_LALT, KC_A, KC_B,         KC_LEFT, KC_DOWN, KC_RGHT
        ),
    [_LOWER] = LAYOUT_all(
